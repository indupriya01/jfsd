        ...
        <header class="header_section">
            <div class="header_top">
                <div class="container-fluid header_top_container">
                    <a class="navbar-brand " href="adminhome.jsp"> Art<span>Gallary</span> </a>
            ...
            <div class="header_bottom">
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand navbar_brand_mobile" href="adminhome.jsp"> Art<span>Gallary</span> </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav  ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="viewallemps.jsp">View Artists</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="viewallcus">View Customers</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="viewallsellers">View Sellers</a>
                                </li>
                                <li class="nav-item">
